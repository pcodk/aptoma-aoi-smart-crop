	...
	if (imageRatio < targetRatio) {
		switch (mode) {
			...
			case modes.TIGHT_AREA_OF_INTEREST_FOCUS_POINT:
				return exports.cropAreaOfInterestVertical(areaOfInterest, targetSize.width, targetSize.height, focusPoint);
			case modes.SAFE:
				return exports.cropVerticalSafe(areaOfInterest, image, targetSize.width, targetSize.height, focusPoint);
			default:
				return exports.cropVerticalCenter(image, focusPoint, targetSize.width, targetSize.height);
		}
	} else {
		switch (mode) {
			case modes.TIGHT_AREA_OF_INTEREST:
			...
			case modes.TIGHT_AREA_OF_INTEREST_FOCUS_POINT:
				return exports.cropAreaOfInterestHorizontal(areaOfInterest, targetSize.width, targetSize.height, image.width, focusPoint);
			case modes.SAFE:
				return exports.cropHorizontalSafe(areaOfInterest, image, targetSize.width, targetSize.height, focusPoint);
			default:
				return exports.cropHorizontalCenter(image, focusPoint, targetSize.width, targetSize.height);
		}
	}
};
